...
var cdsdiscoapiconfig = /** @class */ (function () {
    function cdsdiscoapiconfig() {
    }
    return cdsdiscoapiconfig;
}());
exports.cdsdiscoapiconfig = cdsdiscoapiconfig;
;
var cdsdiscoorgdetaillist = /** @class */ (function () {
    function cdsdiscoorgdetaillist() {
    }
    return cdsdiscoorgdetaillist;
}());
exports.cdsdiscoorgdetaillist = cdsdiscoorgdetaillist;
;
var cdsdiscoorgdetail = /** @class */ (function () {
    function cdsdiscoorgdetail() {
    }
    return cdsdiscoorgdetail;
}());
exports.cdsdiscoorgdetail = cdsdiscoorgdetail;
;
var cdsdiscoapi = /** @class */ (function () {
    function cdsdiscoapi(config) {
        this.config = config;
    ...
    cdsdiscoapi.prototype._restParam = function (func, startIndex) {
    ...
    cdsdiscoapi.prototype.whilst = function (test, iterator, callback) {
        if (test()) {
    ...
    cdsdiscoapi.prototype.GetInstances = function () {
        var _this = this;
    ...
    cdsdiscoapi.prototype.Get = function (orgID, orgName) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var url = null;
            if (orgID != null) {
    ...
    cdsdiscoapi.prototype._BuildQueryHeaders = function () {
        var headers = {};
    ...
    cdsdiscoapi.prototype.parseResponseHeaders = function (headerStr) {
        var headers = {};
        if (!headerStr) {
            return headers;
        }
    ...
    cdsdiscoapi.prototype._GetHttpRequestXMLHTTPRequest = function (method, url, payload, callback) {
        var _this = this;
    ...
    cdsdiscoapi.prototype._GetHttpRequestHTTPS = function (method, url, payload, callback) {
    ...
    cdsdiscoapi.prototype._DateReviver = function (key, value) {
        var a;
...
exports.cdsdiscoapi = cdsdiscoapi;
